  ...
  math: {
    9: [
      ...
      },
      {
        ...
        options: ['x² + 3x - 4 = 0', '2x + 4 = 0', 'x + y = 10', '3x - 5 = 7'],
        correct: 0,
      ...
      },
      {
        ...
        options: ['The hypotenuse', 'The adjacent side', 'The opposite side', 'There is no such side'],
        correct: 0,
    ...
    11: [
      ...
      },
      {
        ...
        options: ['2 seconds', '4 seconds', '1 second', '5 seconds'],
        correct: 0,
  ...
  science: {
    9: [
      ...
      },
      {
        ...
        options: ['An atom', 'A molecule', 'An electron', 'A compound'],
        correct: 0,
    ...
    10: [
      ...
      },
      {
        ...
        options: ['12 m/s', '7 m/s', '4 m/s', '1.33 m/s'],
        correct: 0,
  ...
  history: {
    9: [
      ...
      },
      {
        ...
        options: ['The Ancient Egyptians', 'The Romans', 'The Greeks', 'The Mesopotamians'],
        correct: 0,
  ...
  geography: {
    ...
    10: [
      ...
      },
      {
        ...
        options: ['The Strait of Georgia', 'Hudson Bay', 'The Gulf of St. Lawrence', 'Lake Winnipeg'],
        correct: 0,
      ...
      },
      {
        ...
        options: ['The Ural Mountains', 'The Andes', 'The Rockies', 'The Alps'],
        correct: 0,
    ...
    11: [
      {
        ...
        options: ['Wave action and rising sea levels', 'Volcanic activity', 'Deforestation', 'Earthquakes'],
        correct: 0,
  ...
  english: {
    9: [
      ...
      },
      {
        ...
        options: ['The climax', 'The exposition', 'The resolution', 'The falling action'],
        correct: 0,
    ...
    9: [
      {
        ...
        options: ['la maison', 'le maison', 'la garçon', 'le fille'],
        correct: 0,
    ...
    10: [
      {
        ...
        options: ['It is raining', 'It is sunny', 'It is cold', 'It is windy'],
        correct: 0,
      ...
      },
      {
        ...
        options: ['il parlera', 'il parle', 'il a parlé', 'il parlait'],
        correct: 0,
    ...
    11: [
      {
        ...
        options: ['To feel down or depressed', 'To be hungry', 'To be in a hurry', 'To be excited'],
        correct: 0,
      ...
      },
      {
        ...
        options: ["qu'il ait fini", "qu'il finisse", "qu'il finira", "qu'il a fini"],
        correct: 0,
      ...
      },
      {
        ...
        options: ['est venue', 'a venu', 'vient', 'venait'],
        correct: 0,
